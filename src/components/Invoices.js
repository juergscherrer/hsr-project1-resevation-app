...
class InvoicesPage extends Component {
    ...
    handleChange(item, status){
        ...
        db.ref("reservations/").child(item).child('invoice').update({
            paid: bool,
        });
                    ...
                    <TableBody>
                        ...
                        {Object.keys(reservations).map((item, index) =>
                            <TableRow key={index}>
                                ...
                                <TableCell numeric>{reservations[item].number_of_persons}</TableCell>

                                <TableCell numeric>{reservations[item].invoice.comment}</TableCell>
                                ...
                                <TableCell numeric>
                                    ...
                                    <Checkbox
                                        ...
                                        onChange={(e) => this.handleChange(item, reservations[item].invoice.paid)}
                                        value="checkedA"
                                    />
...
export default withAuthorization(authCondition)(withStyles(styles)(InvoicesPage));
